...
function App() {
  //const APIKEY = "CgmcSpzx2C5xiZCvcJjHPjvDB99Q1VAi0PKt9C7mHVKl7RAo7Kj7rG2h";
  // const endpoint = "https://api.pexels.com/v1/?apikey=$(APIKEY)";
  ...
  useEffect(() => {
    ...
    fetch("https://api.pexels.com/v1/search?query=rivers", requestOptions)
